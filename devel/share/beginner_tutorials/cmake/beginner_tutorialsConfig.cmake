...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/arsovska/Tasks/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/arsovska/Tasks/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/arsovska/Tasks/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'arsovska <arsovska93@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arsovska/Tasks/src/beginner_tutorials/${idir}'.  Ask the maintainer 'arsovska <arsovska93@gmail.com>' to fix it.")
    endif()
