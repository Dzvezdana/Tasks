...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/arsovska/Tasks/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/arsovska/Tasks/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/arsovska/Tasks/install)
...
if(NOT "/home/arsovska/Tasks/src/vision_opencv/cv_bridge/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/arsovska/Tasks/src/vision_opencv/cv_bridge/include;/usr/local/include;/usr/local/include/opencv")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arsovska/Tasks/src/vision_opencv/cv_bridge/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
