  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'Beginner_Tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'arsovska <arsovska@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'Beginner_Tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arsovska/Tasks/src/beginner_tutorials/${idir}'.  Ask the maintainer 'arsovska <arsovska@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/arsovska/Tasks/devel/lib;/opt/ros/jade/lib)
