...
void Translator::enuCallback(const geometry_msgs::TransformStampedConstPtr& msg)
{
...
int main(int argc, char** argv){
  ...
  ros::Subscriber enu_sub = node.subscribe("world/base_tf_enu", 1, &Translator::enuCallback, &translator);
